...
def usarinv():
    ...
    if seleccionado:#se corrobora que un registro este seleccionado
        ...
        invusar = tree.item(seleccionado, "values")[1] #el valor de la segunda columna es el nombre y se guarda
...
def agregarinv():
    ...
    if seleccionado:#se corrobora que un registro este seleccionado
        # Obtener los valores del elemento seleccionado
        tabla = tabla = combo_tabla.get()#para saber que se selecciono
        invagregar = tree.item(seleccionado, "values")[1] #el valor de la segunda columna es el nombre y se guarda
...
combo_tabla = ttk.Combobox(ventana, values=opciones)#se crea el combobox y como valores se le pone opciones
