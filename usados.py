...
def eliminar():#para elimianr el seleccionado
    ...
    if seleccionado:#se corrobora que un registro este seleccionado
        ...
        if opcion == 'yes':
            cone.eliminar_registro(conexion, "usados", id)#se manda a eliminar el usuario con la id seleccionada
...
if filas:#solo si consiguio informacion la mostrara ya que si no sale una excepcion
    ...
    tree.column('0', width='10')#cambio el ancho de una columna 
    tree.column('1', width='10')#cambio el ancho de una columna
    ...
    tree.column('5', width='100')#cambio el ancho de una columna
    tree.column('6', width='50')#cambio el ancho de una columna
    tree.column('7', width='50')#cambio el ancho de una columna
